...
<head>
    ...
    <link rel="stylesheet" href="approved_students_scroll.css">
    <style>
        .modal {
            display: none;
            position: fixed;
        ...
        /* Scoped override to ensure horizontal scroll space for Approved Students */
...
<body class="admin-layout" data-theme="light">
    ...
    <div class="card" id="approved-students-section" style="margin-top: 30px;">
