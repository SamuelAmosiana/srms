...
<head>
    ...
    <title>Short Courses Applications - LSC SRMS</title>
...
<body class="admin-layout" data-theme="light">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <a href="short_courses_applications.php" class="nav-item active">
    ...
    <main class="main-content">
        <div class="content-header">
            <h1><i class="fas fa-book"></i> Short Courses Applications</h1>
            <p>Manage short courses student applications</p>
        </div>
        ...
        <div class="data-panel">
            <div class="panel-header">
                <h3><i class="fas fa-book"></i> Pending Short Courses Applications (<?php echo count($shortCoursesApplications); ?>)</h3>
            </div>
            <div class="panel-content">
                <?php if (empty($shortCoursesApplications)): ?>
                ...
                <?php else: ?>
                    <div class="table-responsive">
                        <table class="data-table">
                            ...
                            <tbody>
                                <?php foreach ($shortCoursesApplications as $app): ?>
                                    <tr>
        ...
        function viewApplication(app) {
            ...
            try {
                ...
                if (Array.isArray(documents)) {
                    ...
                    // Handle object format (short course applications with additional info)
                    const fileDocs = [];
