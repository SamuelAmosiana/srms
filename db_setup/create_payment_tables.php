...
echo "Creating payment system tables...\n";
...
try {
    ...
    $pdo->exec($sql);
    echo "✓ Payments table created/updated\n";
    ...
    $pdo->exec($sql);
    echo "✓ Finance income table created/updated\n";
    ...
    CREATE TABLE IF NOT EXISTS payment_logs (
        ...
        transaction_reference VARCHAR(50) NOT NULL,
        raw_response TEXT,
        action_taken ENUM('initiated', 'confirmed', 'rejected', 'failed'),
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
    )";
    
    $pdo->exec($sql);
    echo "✓ Payment logs table created/updated\n";
