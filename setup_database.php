<?php
// Database setup script for LSC SRMS
echo "<h1>LSC SRMS Database Setup</h1>";

try {
    // First, connect without specifying database to create it
    $pdo_setup = new PDO("mysql:host=127.0.0.1;charset=utf8mb4", 'root', '', [
    ...
    $schema = file_get_contents('sql/lscrms_schema.sql');
